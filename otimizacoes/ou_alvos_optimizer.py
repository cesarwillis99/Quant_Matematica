...
"""
================================================
ou_alvos_optimizer.py — Estratégia Quantitativa
...
Uso:
  ...
  3. Executar: python ou_alvos_optimizer.py
================================================
"""
...
SPREAD_PIPS        = 0.5  # Calibrado sob spread de 0.5 pips da V2
...
def rodar_otimizacao_ou():
    ...
    if not PARQUET_COMPLETO.exists():
        raise FileNotFoundError(f"Parquet OU não encontrado em: {PARQUET_COMPLETO}. Rode primeiro: python ou_strategy.py")
