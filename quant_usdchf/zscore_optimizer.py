...
"""
================================================================================
zscore_optimizer.py — Otimizador de Parâmetros para a Estratégia Z-Score H1
================================================================================

Objetivo:
    Testar sistematicamente combinações de parâmetros da estratégia Z-Score:
    1. Thresholds de Entrada do Z-Score
    2. Limite do Regime de Hurst
    3. Tipo de Gatilho (DIRETO na batida vs RETORNO cruzando de volta)
...
PARQUET_ENTRADA = DIR_PROJETO / "data" / "usdchf_h1_zscore.parquet"

CAPITAL_INICIAL    = 10_000.0
RISCO_POR_TRADE    = 0.01
SPREAD_PIPS        = 1.0  # Recalculado sob spread de 0.6 pips
