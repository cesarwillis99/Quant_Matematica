...
"""
================================================================================
backtest.py — Simulação Histórica Multiestratégia USDCHF H1
================================================================================
...
Mecânica do Backtest:
    - Iteração candle a candle sobre toda a base USDCHF H1
...
Arquivos de entrada:
    - quant_usdchf_v2/data/usdchf_h1_zscore.parquet
    - quant_usdchf_v2/data/usdchf_h1_momentum.parquet
    - quant_usdchf_v2/data/usdchf_h1_ou.parquet

Arquivos de saída:
    - quant_usdchf/graficos/equity_curves.png e quant_usdchf_v2/graficos/equity_curves.png
    - quant_usdchf/resultados/operacoes.csv e quant_usdchf_v2/resultados/operacoes.csv
    - quant_usdchf/resultados/metricas.csv e quant_usdchf_v2/resultados/metricas.csv
...
DIR_PROJETO_V1 = DIR_ATUAL.parent / "quant_usdchf"

# Parquets de Entrada (Sempre lidos de V2)
PARQUET_ZSCORE   = DIR_PROJETO_V2 / "data" / "usdchf_h1_zscore.parquet"
PARQUET_MOMENTUM = DIR_PROJETO_V2 / "data" / "usdchf_h1_momentum.parquet"
PARQUET_OU       = DIR_PROJETO_V2 / "data" / "usdchf_h1_ou.parquet"

# Parâmetros de Simulação
CAPITAL_INICIAL    = 10_000.0   # USD
RISCO_POR_TRADE    = 0.01       # 1% por trade
SPREAD_PIPS        = 1.0        # Spread de 0.6 pips
VALOR_PIP_POR_LOTE = 10.0       # 10 USD por pip por lote padrão
FATOR_PIPS         = 10_000.0   # 1 pip = 0.0001 no USDCHF
...
def gerar_grafico_equity_curves(
    ...
    fig.suptitle(
        "USDCHF H1 — Equity Curves Históricas e Perfil de Drawdown (ZScore, Momentum, OU, Combinada)",
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Backtester Manual Multiestratégia USDCHF H1",
    ...
    print("\n" + "█" * 70)
    print("█" + " " * 68 + "█")
    print("█   INICIANDO PIPELINE DE BACKTEST MULTIESTRATÉGIA USDCHF H1   █")
