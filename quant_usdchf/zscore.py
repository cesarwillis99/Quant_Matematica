...
PARQUET_SAIDA   = DIR_DATA / "usdchf_h1_zscore.parquet"
...
def gerar_sinais_zscore(df: pd.DataFrame) -> tuple:
    ...
    # Usamos a coluna hurst diretamente < 0.45
...
def gerar_grafico_zscore_sinais(df: pd.DataFrame):
    ...
    fig.suptitle("Estratégia Mean Reversion por Z-Score — USDCHF H1", fontsize=16, fontweight='bold', color='#FFFFFF')
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Módulo Mean Reversion por Z-Score — USDCHF H1",
    ...
    print("\n" + "█" * 70)
    print("█" + " " * 68 + "█")
    print("█   ESTRATÉGIA MEAN REVERSION POR Z-SCORE USDCHF v2             █")
