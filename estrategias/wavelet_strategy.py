...
"""
================================================
wavelet_strategy.py — Estratégia Quantitativa
...
Uso:
  ...
  3. Executar: python wavelet_strategy.py
================================================
"""
...
def main():
    parser = argparse.ArgumentParser(description=f"Módulo Wavelet CWT {ATIVO} {TIMEFRAME}")
