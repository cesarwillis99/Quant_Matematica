...
Saída:
    - data/gbpusd_h1_momentum.parquet
...
PARQUET_ENTRADA = DIR_DATA / "gbpusd_h1_hurst.parquet"
PARQUET_SAIDA   = DIR_DATA / "gbpusd_h1_momentum.parquet"
...
def gerar_grafico_momentum_sinais(df: pd.DataFrame):
    ...
    Painel 1: Preço GBPUSD com setas de compra e venda
    ...
    fig.suptitle("Estratégia Momentum & Entropia — GBPUSD H1", fontsize=16, fontweight='bold', color='#FFFFFF')
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Módulo Momentum e Entropia — GBPUSD H1",
    ...
    print("\n" + "█" * 70)
    print("█" + " " * 68 + "█")
    print("█   ESTRATÉGIA DE MOMENTUM E ENTROPIA GBPUSD v2                 █")
