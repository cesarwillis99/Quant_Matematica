...
def gerar_grafico_ou(df: pd.DataFrame):
    ...
    fig.suptitle("Ornstein-Uhlenbeck (OU) Mean Reversion Strategy — EURUSD H1", fontsize=16, fontweight='bold', color='#FFFFFF')
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Módulo Ornstein-Uhlenbeck Mean Reversion — EURUSD H1",
