...
"""
================================================
ou_strategy.py — Estratégia Quantitativa
...
Uso:
  ...
  3. Executar: python ou_strategy.py
================================================
"""
...
PARQUET_SAIDA       = DIR_DATA / "ou" / f"{ATIVO.lower()}_{TIMEFRAME.lower()}_ou.parquet"
CAMINHO_GRAFICO     = DIR_GRAFICOS / f"{ATIVO.lower()}_{TIMEFRAME.lower()}_ou_sinais.png"
...
def gerar_grafico_ou(df: pd.DataFrame):
    ...
    fig.suptitle(f"Ornstein-Uhlenbeck (OU) Mean Reversion Strategy — {ATIVO} {TIMEFRAME}", fontsize=16, fontweight='bold', color='#FFFFFF')
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description=f"Módulo Ornstein-Uhlenbeck Mean Reversion — {ATIVO} {TIMEFRAME}",
    ...
    print("\n" + "█" * 70)
    print("█" + " " * 68 + "█")
    print(f"█   ESTRATÉGIA MEAN REVERSION ORNSTEIN-UHLENBECK {ATIVO} {TIMEFRAME}     █")
