...
"""
================================================================================
hawkes_optimizer.py — Otimizador de Grade (Grid Search) para o Motor de Hawkes
================================================================================

Otimização Matemática Isolada para o Modelo de Autoexcitação (Hawkes Process).
Lógica:
    - Carrega a base 'eurusd_h1_hawkes.parquet' que já contém as estimativas MLE pesadas.
    - Utiliza o Pool de Processos para simular centenas de combinações em segundos.
    - Regras simuladas barra-a-barra garantindo 100% de consistência com o motor real.
"""
...
PARQUET_COMPLETO = DIR_ATUAL / "data" / "eurusd_h1_hawkes.parquet"
