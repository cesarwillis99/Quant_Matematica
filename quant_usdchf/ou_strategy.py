...
PARQUET_SAIDA   = DIR_DATA / "usdchf_h1_ou.parquet"
...
def gerar_grafico_ou(df: pd.DataFrame):
    ...
    fig.suptitle("Ornstein-Uhlenbeck (OU) Mean Reversion Strategy — USDCHF H1", fontsize=16, fontweight='bold', color='#FFFFFF')
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Módulo Ornstein-Uhlenbeck Mean Reversion — USDCHF H1",
    ...
    print("\n" + "█" * 70)
    print("█" + " " * 68 + "█")
    print("█   ESTRATÉGIA MEAN REVERSION ORNSTEIN-UHLENBECK USDCHF H1     █")
