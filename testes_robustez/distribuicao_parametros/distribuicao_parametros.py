...
def main():
    ...
    # 1. Pelo menos 80% dos parametros devem ser aprovados (estabilidade individual)
    # 2. Todos os resultados de PnL de todas as perturbacoes da distribuicao devem ser nao-negativos (>= 0.0%)
    total_p = len(resultados_por_param)
