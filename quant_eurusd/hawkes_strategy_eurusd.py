...
"""
================================================================================
hawkes_strategy.py — Estratégia Baseada em Processo de Hawkes (Teoria das Filas)
================================================================================

Módulo de Processos Estocásticos para modelar a chegada de eventos extremos.
Lógica:
    - Identifica 'eventos' quando o log-retorno excede 2 Desvios Padrões rolando (60 períodos).
    - Estima parâmetros (μ, α, β) via Maximum Likelihood Estimation (MLE) a cada 24 horas 
      usando os últimos 120 períodos.
    - Calcula iterativamente a intensidade λ_t usando os parâmetros congelados da última estimação.
    - Detecta exaustão do cluster (queda na intensidade após um pico) para apostar em reversão.
"""
...
PARQUET_SAIDA = DIR_ATUAL / "data" / "eurusd_h1_hawkes.parquet"
