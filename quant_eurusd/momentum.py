...
PARQUET_SAIDA   = DIR_DATA / "eurusd_h1_momentum.parquet"
...
def gerar_grafico_momentum_sinais(df: pd.DataFrame):
    ...
    fig.suptitle("Estratégia Momentum & Entropia — EURUSD H1", fontsize=16, fontweight='bold', color='#FFFFFF')
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Módulo Momentum e Entropia — EURUSD H1",
    ...
    print("\n" + "█" * 70)
    print("█" + " " * 68 + "█")
    print("█   ESTRATÉGIA DE MOMENTUM E ENTROPIA EURUSD v2                 █")
